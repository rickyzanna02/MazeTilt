...
LEVELS = {
    ...
    4: {
        "walls": [
            ...
            ("min", "min", 11.0, 5.5, -8.0, "T"),

            ("min", "min", 0.0, 12.5, 15.0, "T"),
            ("min", "min", 15.0, 13.25, "T", -6.0),

            ("max", "max", 0.0, -9.0, -12.0, "T"),

            ("max", "max", -5.0, 0.0, "T", -4.0),
        ],
        "holes": [
            (-4.0, -4.0, 1.0),
            (6.0, -9.0, 1.0),
    ...
    5: {
        "walls": [
            ("max", "min", 0.0, 6.0, -9.0, "T"),
            ("min", "min", 9.0, 6.0, "T", 6.0),
            ("max", "min", -9.0, 12.0, -5.0, "T"),

            ("min", "min", 0.0, 18.0, 12.0, "T"),

            ("max", "max", 0.0, -5.0, -8.0, "T"),
